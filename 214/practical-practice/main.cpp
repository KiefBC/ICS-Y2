...
// Counts the number of times a character is repeated in a string using
// std::string
...
// Counts the number of times a character is repeated in a string using c string
...
// Returns the character that is repeated the most in a string using std::string
...
// Returns the character that is repeated the most in a string using c string
...
// Replaces all vowels in a string with an asterisk
...
int main() {
  ...
  std::cout << "Repeat Char (std::string) " << Constants::CHARACTER
            << " repeated " << repeatResult << " times" << std::endl;

  char cString[] = {"Kiefer Kyler Killer"};
  int repeatResult2 = numOfTimes(Constants::CSTRING, Constants::CHARACTER);
  std::cout << "Repeat Char (c string) " << Constants::CHARACTER << " repeated "
            << repeatResult2 << " times" << std::endl;
  ...
  std::cout << "Student: " << student->name << " has the ID: " << student->id
            << std::endl;
  delete student;
