...
// Calling _CrtMemDumpAllObjectsSince(NULL); at the very end of your main()
// function should output memory leaks along with line numbers to the console.
// For this to work correctly, all prior code should be inside a block { } of
// some sort so that any vars that get created (on the call stack) get
// destroyed.  The dump should be called after the closing brace of the block
